										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control" type="text"
													placeholder="호텔 소개 입력" name="hotelManual">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label">All Room EA</label>
											<div class="col-sm-3">
												<input class="form-control" type="number"
													placeholder="전체 방 개수 입력" name="hotelAllRoomEA">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label"></label>
											<div class="col-sm-10">
												<button type="button" class="btn btn-warning btn-lg mx-auto" onclick="insertHotel();">등록하기</button>
											</div>
										</div>
									</div>
									<!-- /.col -->
